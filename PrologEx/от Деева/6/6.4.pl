...
выдать_сведения(член(Фамилия,Возраст,Данные_об_уплате)):-
	член(Фамилия,Возраст,Данные_об_уплате),взнос(Возраст,Сумма),
...
подсчет_членов(член(Фамилия,Возраст,Данные_об_уплате),_):-
	...
	увеличить_счетчик(число_членов,1),fail.
...
меню:-repeat,
	...
	write('4. Удалить члена клуба.'),nl,
	write('5. Внесение отметки об уплате взноса.'),nl,
	write('0. ВЫХОД'),nl,nl,
...
пункт(1):-nl,write('Состав клуба:'),nl,выдать_сведения(_),!.
...
пункт(4):-nl,write('Введите данные члена клуба '),nl,
	write('Фамилия '),read(Фамилия),
	write('Возраст '),read(Возраст),
	удалить_члена_клуба(член(Фамилия,Возраст,_)),!.

пункт(5):-nl,write('Введите данные члена клуба '),nl,
	write('Фамилия '),read(Фамилия),
	write('Возраст '),read(Возраст),
	уплатил_взнос(член(Фамилия,Возраст)),!.
